...
// Client lists the podinfo service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the podinfo service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Get returns an endpoint that makes HTTP requests to the podinfo service get
// server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("podinfo", "get", err)
		}
